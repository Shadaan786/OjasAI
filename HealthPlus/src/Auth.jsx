  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isLogin) {
        ...
        const doctorAccounts = JSON.parse(
          localStorage.getItem("ojasai_doctor_accounts") || "[]"
        );
        const isDoctorAccount = doctorAccounts.includes(
        ...
        const destination =
          loginRole === "doctor" ? "/doctor-dashboard" : "/getStarted";
        ...
        if (loginRole === "doctor") {
          ...
          const updatedDoctors = Array.from(
            new Set([...doctorAccounts, trimmedEmail.toLowerCase()])
          );
          localStorage.setItem(
            "ojasai_doctor_accounts",
    ...
    <div className="auth-container">
      <div className="auth-card">
        <div className="auth-header">
          ...
          <h1>
            {isLogin
              ? `Welcome Back ${loginRole === "doctor" ? "Doctor" : ""}`.trim()
              : `Create ${loginRole === "doctor" ? "Doctor" : "Patient"} Account`}
          </h1>

          <p>
            {isLogin
              ? `Please sign in to your ${loginRole} account`
              : `Join as a ${loginRole} and get started today`}
          </p>
        </div>
        ...
        <div className="healthcare-security-notice">
          ...
          <div>
            ...
            <span>
              Your health data is encrypted and protected with medical-grade
              security
            </span>
          </div>
        </div>
